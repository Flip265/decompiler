...
local function main()
	...
	local SaveInstanceArgs = {
		...
		SaveTerrain = terrainGridData.realcheck,
		TerrainPhysicsGrid = terrainGridData.physicsgrid,
		TerrainSmoothGrid = terrainGridData.smoothgrid
	}
